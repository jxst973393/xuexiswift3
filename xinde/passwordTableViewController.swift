...
class passwordTableViewController: UITableViewController {
    ...
    @IBAction func pass(_ sender: Any) {
        let ccc = useroldpassword.text
        let bbb = usernewpassword.text
        
        current?.updatePassword(ccc!, newPassword: bbb!) { (results,error) in
    ...
    override func viewDidLoad() {
        ...
        usernewpassword.placeholder = "请输入新的密码"
